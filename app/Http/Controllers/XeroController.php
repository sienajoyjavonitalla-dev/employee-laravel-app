...
class XeroController extends Controller
{
    public function get_started() {
        $url = 'https://login.xero.com/identity/connect/authorize?response_type=code&client_id=2BC3D6774F2A482D81379F568045B2FD&redirect_uri='.urlencode('http://localhost:8000/xero/callback').'&scope=openid profile email accounting.transactions&state=123';
