    ...
    var t = (function () {
        ...
        e = (function () {
            function e(t, e, o, n, i, s) {
                (this.startPoint = t), (this.control2 = e), (this.control1 = o), (this.endPoint = n), (this.startWidth = i), (this.endWidth = s);
            }
            return (
                ...
                (e.prototype.length = function () {
                    for (var t, e, o = 0, n = 0; n <= 10; n += 1) {
                        var i = n / 10,
                            s = this.point(i, this.startPoint.x, this.control1.x, this.control2.x, this.endPoint.x),
                            r = this.point(i, this.startPoint.y, this.control1.y, this.control2.y, this.endPoint.y);
                        if (n > 0) {
                            var h = s - t,
                                a = r - e;
                            o += Math.sqrt(h * h + a * a);
                ...
                (e.prototype.point = function (t, e, o, n, i) {
                    return e * (1 - t) * (1 - t) * (1 - t) + 3 * o * (1 - t) * (1 - t) * t + 3 * n * (1 - t) * t * t + i * t * t * t;
                }),
                e
            );
        })();
    return (function () {
                ...
                this.throttle
                    ? (this._strokeMoveUpdate = (function (t, e) {
                          ...
                          var o,
                              ...
                              r = null,
                              h = function () {
                                  (s = Date.now()), (r = null), (o = t.apply(n, i)), r || ((n = null), (i = []));
                              };
                          return function () {
                              for (var a = [], c = 0; c < arguments.length; c++) a[c] = arguments[c];
                              var u = Date.now(),
                                  d = e - (u - s);
                              return (n = this), (i = a), d <= 0 || d > e ? (r && (clearTimeout(r), (r = null)), (s = u), (o = t.apply(n, i)), r || ((n = null), (i = []))) : r || (r = window.setTimeout(h, d)), o;
                          };
        ...
        return (
            ...
            (o.prototype._strokeBegin = function (t) {
                ...
                this._data.push(e), this._reset(), this._strokeUpdate(t), "function" == typeof this.onBegin && this.onBegin(t);
            }),
            (o.prototype._strokeUpdate = function (t) {
                ...
                if (!r || !r || !h) {
                    ...
                    r ? c && this._drawCurve({ color: a, curve: c }) : this._drawDot({ color: a, point: n }), s.push({ time: n.time, x: n.x, y: n.y });
                }
            }),
            ...
            (o.prototype._calculateCurveWidths = function (t, e) {
                var o = this.velocityFilterWeight * e.velocityFrom(t) + (1 - this.velocityFilterWeight) * this._lastVelocity,
            ...
            (o.prototype._drawCurveSegment = function (t, e, o) {
                var n = this._ctx;
                n.moveTo(t, e), n.arc(t, e, o, 0, 2 * Math.PI, !1), (this._isEmpty = !1);
            }),
            (o.prototype._drawCurve = function (t) {
                ...
                for (var r = 0; r < s; r += 1) {
                    var h = r / s,
                        ...
                        l = d * u,
                        v = l * o.startPoint.x;
                    (v += 3 * d * h * o.control1.x), (v += 3 * u * a * o.control2.x), (v += c * o.endPoint.x);
                    var p = l * o.startPoint.y;
                    (p += 3 * d * h * o.control1.y), (p += 3 * u * a * o.control2.y), (p += c * o.endPoint.y);
            ...
            (o.prototype._drawDot = function (t) {
                ...
                n.beginPath(), this._drawCurveSegment(o.x, o.y, i), n.closePath(), (n.fillStyle = e), n.fill();
            }),
                    ...
                    this._fromData(
                        ...
                        function (t) {
                            ...
                            if (!(isNaN(o.control1.x) || isNaN(o.control1.y) || isNaN(o.control2.x) || isNaN(o.control2.y))) {
                                ...
                                n.setAttribute("d", i),
                                    n.setAttribute("stroke-width", (2.25 * o.endWidth).toFixed(3)),
                        ...
                        function (e) {
                            var o = e.color,
                                ...
                                r = "function" == typeof t.dotSize ? t.dotSize() : t.dotSize;
                            i.setAttribute("r", r.toString()), i.setAttribute("cx", n.x.toString()), i.setAttribute("cy", n.y.toString()), i.setAttribute("fill", o), s.appendChild(i);
                        }
                    );
                var r = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 ' + n + " " + i + '" width="' + n + '" height="' + i + '">',
                    h = s.innerHTML;
                if (void 0 === h) {
                    var a = document.createElement("dummy"),
                        c = s.childNodes;
                    a.innerHTML = "";
                    for (var u = 0; u < c.length; u += 1) a.appendChild(c[u].cloneNode(!0));
                    h = a.innerHTML;
                }
